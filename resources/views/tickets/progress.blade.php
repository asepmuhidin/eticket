        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <hr>
                        <h4>Progress Ticket </h4>
                        <p>
                    </div>
                </div>            
                     
                <form action="{{ route('tickets.progress', $ticket->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                <div class="row">
                    <div class="col-md-4">
                        <label for="complain_date" class="col-md-12 col-form-label text-md-end text-start">Change Status</label>
                    ...
                    <div class="col-md-4">
                        <label class="col-md-12 col-form-label text-md-end text-start">&nbsp;</label>
