            ...
            <div class="card-body">
                <form action="{{ route('blocks.update', $block->id) }}" method="post">
                        ...
                        <div class="col-md-6">
                          <select class="form-control @error('cluster_id') is-invalid @enderror" id="cluster_id" name="cluster_id">
                            @foreach ($clusters as $cluster)
                                <option value="{{ $cluster->id }}" {{ $cluster->id == $block->cluster_id ? 'selected' : '' }}>{{ $cluster->name }}</option>
                            @endforeach
                          </select>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="text" class="form-control @error('alpha1') is-invalid @enderror" id="alpha1" name="alpha1" value="{{ $block->alpha1 }}">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control @error('alpha2') is-invalid @enderror" id="alpha2" name="alpha2" value="{{ $block->alpha2 }}">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control @error('num1') is-invalid @enderror" id="num1" name="num1" value="{{ $block->num1 }}">
                            @if ($errors->has('num1'))
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control @error('num2') is-invalid @enderror" id="num2" name="num2" value="{{ $block->num2 }}">
                            @if ($errors->has('num2'))
                    ...
                    <div class="mb-3 row">
                        <input type="submit" class="col-md-3 offset-md-5 btn btn-primary" value="Update Block">
                    </div>
