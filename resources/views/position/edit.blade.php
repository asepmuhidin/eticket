            ...
            <div class="card-body">
                <form action="{{ route('position.update', $position->id) }}" method="post">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="text" class="form-control @error('name') is-invalid @enderror" id="title" name="title" value="{{ $position->title }}">
                            @if ($errors->has('title'))
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description">{{ $position->description }}</textarea>
